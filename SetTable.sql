...
CREATE TYPE HOUSE_TYPE AS ENUM ('APARTMENTS', 'VILLAS', 'HIGH_END','ORDINARY');
...
CREATE TYPE CITY AS ENUM('SHANGHAI', 'BEIJING', 'SHENZHEN', 'GUANGZHOU', 'CHENGDU','PARIS', 'MARSEILLE', 'LYON', 'TOULOUSE','CAMBRIDGE', 'EDINBURGH',  'LONDON', 'LIVERPOOL','NEW_YORK', 'LOS_ANGELES', 'CHICAGO', 'BOSTON');
